...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'theater-comedy' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaTheaterComedyPage() {
  try {
    ...
    console.error('Error in IbizaTheaterComedyPage:', error);
    return (
      <DiscoveryClient
