...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'theater-comedy', date: 'morgen' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaTheaterComedyMorgenPage() {
  try {
    ...
    console.error('Error in IbizaTheaterComedyMorgenPage:', error);
    return (
      <DiscoveryClient
