...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'theater-comedy', date: 'heute' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaTheaterComedyHeutePage() {
  try {
    ...
    console.error('Error in IbizaTheaterComedyHeutePage:', error);
    return (
      <DiscoveryClient
