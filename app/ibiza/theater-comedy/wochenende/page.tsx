...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'theater-comedy', date: 'wochenende' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaTheaterComedyWochenendePage() {
  try {
    ...
    console.error('Error in IbizaTheaterComedyWochenendePage:', error);
    return (
      <DiscoveryClient
