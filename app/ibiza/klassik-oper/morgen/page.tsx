...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'klassik-oper', date: 'morgen' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaKlassikOperMorgenPage() {
  try {
    ...
    console.error('Error in IbizaKlassikOperMorgenPage:', error);
    return (
      <DiscoveryClient
