...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'klassik-oper', date: 'heute' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaKlassikOperHeutePage() {
  try {
    ...
    console.error('Error in IbizaKlassikOperHeutePage:', error);
    return (
      <DiscoveryClient
