...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'klassik-oper' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaKlassikOperPage() {
  try {
    ...
    console.error('Error in IbizaKlassikOperPage:', error);
    return (
      <DiscoveryClient
