...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'clubs-nachtleben', date: 'morgen' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaClubsNachtlebenMorgenPage() {
  try {
    ...
    console.error('Error in IbizaClubsNachtlebenMorgenPage:', error);
    return (
      <DiscoveryClient
