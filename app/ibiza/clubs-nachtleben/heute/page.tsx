...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'clubs-nachtleben', date: 'heute' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaClubsNachtlebenHeutePage() {
  try {
    ...
    console.error('Error in IbizaClubsNachtlebenHeutePage:', error);
    return (
      <DiscoveryClient
