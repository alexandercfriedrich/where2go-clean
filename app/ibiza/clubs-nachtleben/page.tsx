...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'clubs-nachtleben' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaClubsNachtlebenPage() {
  try {
    ...
    console.error('Error in IbizaClubsNachtlebenPage:', error);
    return (
      <DiscoveryClient
