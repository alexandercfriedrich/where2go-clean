...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'lgbtq', date: 'wochenende' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaLgbtqWochenendePage() {
  try {
    ...
    console.error('Error in IbizaLgbtqWochenendePage:', error);
    return (
      <DiscoveryClient
