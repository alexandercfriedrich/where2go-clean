...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'lgbtq', date: 'morgen' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaLgbtqMorgenPage() {
  try {
    ...
    console.error('Error in IbizaLgbtqMorgenPage:', error);
    return (
      <DiscoveryClient
