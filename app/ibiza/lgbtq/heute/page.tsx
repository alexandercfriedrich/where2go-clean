...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'lgbtq', date: 'heute' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaLgbtqHeutePage() {
  try {
    ...
    console.error('Error in IbizaLgbtqHeutePage:', error);
    return (
      <DiscoveryClient
