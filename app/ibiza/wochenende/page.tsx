...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', date: 'wochenende' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaWochenendePage() {
  try {
    ...
    console.error('Error in IbizaWochenendePage:', error);
    return (
      <DiscoveryClient
