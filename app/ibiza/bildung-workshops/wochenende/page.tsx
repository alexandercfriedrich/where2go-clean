...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'bildung-workshops', date: 'wochenende' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaBildungWorkshopsWochenendePage() {
  try {
    ...
    console.error('Error in IbizaBildungWorkshopsWochenendePage:', error);
    return (
      <DiscoveryClient
