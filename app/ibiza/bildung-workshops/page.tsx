...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'bildung-workshops' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaBildungWorkshopsPage() {
  try {
    ...
    console.error('Error in IbizaBildungWorkshopsPage:', error);
    return (
      <DiscoveryClient
