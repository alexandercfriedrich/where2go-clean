...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'bildung-workshops', date: 'heute' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaBildungWorkshopsHeutePage() {
  try {
    ...
    console.error('Error in IbizaBildungWorkshopsHeutePage:', error);
    return (
      <DiscoveryClient
