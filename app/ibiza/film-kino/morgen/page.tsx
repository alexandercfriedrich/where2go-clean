...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'film-kino', date: 'morgen' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaFilmKinoMorgenPage() {
  try {
    ...
    console.error('Error in IbizaFilmKinoMorgenPage:', error);
    return (
      <DiscoveryClient
