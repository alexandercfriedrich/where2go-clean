...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'film-kino', date: 'heute' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaFilmKinoHeutePage() {
  try {
    ...
    console.error('Error in IbizaFilmKinoHeutePage:', error);
    return (
      <DiscoveryClient
