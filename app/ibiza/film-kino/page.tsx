...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'film-kino' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaFilmKinoPage() {
  try {
    ...
    console.error('Error in IbizaFilmKinoPage:', error);
    return (
      <DiscoveryClient
