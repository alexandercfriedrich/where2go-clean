...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'kulinarik-maerkte' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaKulinarikMaerktePage() {
  try {
    ...
    console.error('Error in IbizaKulinarikMaerktePage:', error);
    return (
      <DiscoveryClient
