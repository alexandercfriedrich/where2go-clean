...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'kulinarik-maerkte', date: 'heute' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaKulinarikMaerkteHeutePage() {
  try {
    ...
    console.error('Error in IbizaKulinarikMaerkteHeutePage:', error);
    return (
      <DiscoveryClient
