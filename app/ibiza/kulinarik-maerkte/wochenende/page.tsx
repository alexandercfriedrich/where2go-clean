...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'kulinarik-maerkte', date: 'wochenende' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaKulinarikMaerkteWochenendePage() {
  try {
    ...
    console.error('Error in IbizaKulinarikMaerkteWochenendePage:', error);
    return (
      <DiscoveryClient
