...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'familie-kinder', date: 'heute' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaFamilieKinderHeutePage() {
  try {
    ...
    console.error('Error in IbizaFamilieKinderHeutePage:', error);
    return (
      <DiscoveryClient
