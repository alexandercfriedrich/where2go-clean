...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'familie-kinder' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaFamilieKinderPage() {
  try {
    ...
    console.error('Error in IbizaFamilieKinderPage:', error);
    return (
      <DiscoveryClient
