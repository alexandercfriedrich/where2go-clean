...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'familie-kinder', date: 'wochenende' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaFamilieKinderWochenendePage() {
  try {
    ...
    console.error('Error in IbizaFamilieKinderWochenendePage:', error);
    return (
      <DiscoveryClient
