...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'sport-fitness', date: 'morgen' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaSportFitnessMorgenPage() {
  try {
    ...
    console.error('Error in IbizaSportFitnessMorgenPage:', error);
    return (
      <DiscoveryClient
