...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'sport-fitness', date: 'wochenende' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaSportFitnessWochenendePage() {
  try {
    ...
    console.error('Error in IbizaSportFitnessWochenendePage:', error);
    return (
      <DiscoveryClient
