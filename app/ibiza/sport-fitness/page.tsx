...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'sport-fitness' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaSportFitnessPage() {
  try {
    ...
    console.error('Error in IbizaSportFitnessPage:', error);
    return (
      <DiscoveryClient
