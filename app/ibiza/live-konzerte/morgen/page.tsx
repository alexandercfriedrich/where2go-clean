...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'live-konzerte', date: 'morgen' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaLiveKonzerteMorgenPage() {
  try {
    ...
    console.error('Error in IbizaLiveKonzerteMorgenPage:', error);
    return (
      <DiscoveryClient
