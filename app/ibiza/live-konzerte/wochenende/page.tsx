...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'live-konzerte', date: 'wochenende' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaLiveKonzerteWochenendePage() {
  try {
    ...
    console.error('Error in IbizaLiveKonzerteWochenendePage:', error);
    return (
      <DiscoveryClient
