...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'live-konzerte' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaLiveKonzertePage() {
  try {
    ...
    console.error('Error in IbizaLiveKonzertePage:', error);
    return (
      <DiscoveryClient
