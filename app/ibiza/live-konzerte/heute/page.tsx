...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'live-konzerte', date: 'heute' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaLiveKonzerteHeutePage() {
  try {
    ...
    console.error('Error in IbizaLiveKonzerteHeutePage:', error);
    return (
      <DiscoveryClient
