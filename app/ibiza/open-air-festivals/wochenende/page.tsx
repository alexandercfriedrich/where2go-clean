...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'open-air-festivals', date: 'wochenende' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaOpenAirFestivalsWochenendePage() {
  try {
    ...
    console.error('Error in IbizaOpenAirFestivalsWochenendePage:', error);
    return (
      <DiscoveryClient
