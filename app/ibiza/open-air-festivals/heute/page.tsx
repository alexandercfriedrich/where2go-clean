...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'open-air-festivals', date: 'heute' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaOpenAirFestivalsHeutePage() {
  try {
    ...
    console.error('Error in IbizaOpenAirFestivalsHeutePage:', error);
    return (
      <DiscoveryClient
