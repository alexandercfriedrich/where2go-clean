...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'open-air-festivals' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaOpenAirFestivalsPage() {
  try {
    ...
    console.error('Error in IbizaOpenAirFestivalsPage:', error);
    return (
      <DiscoveryClient
