...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'open-air-festivals', date: 'morgen' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaOpenAirFestivalsMorgenPage() {
  try {
    ...
    console.error('Error in IbizaOpenAirFestivalsMorgenPage:', error);
    return (
      <DiscoveryClient
