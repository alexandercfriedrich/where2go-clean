...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'museen-ausstellungen', date: 'wochenende' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaMuseenAusstellungenWochenendePage() {
  try {
    ...
    console.error('Error in IbizaMuseenAusstellungenWochenendePage:', error);
    return (
      <DiscoveryClient
