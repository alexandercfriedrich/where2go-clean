...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'museen-ausstellungen', date: 'heute' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaMuseenAusstellungenHeutePage() {
  try {
    ...
    console.error('Error in IbizaMuseenAusstellungenHeutePage:', error);
    return (
      <DiscoveryClient
