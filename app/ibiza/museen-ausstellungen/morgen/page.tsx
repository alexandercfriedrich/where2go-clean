...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'museen-ausstellungen', date: 'morgen' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaMuseenAusstellungenMorgenPage() {
  try {
    ...
    console.error('Error in IbizaMuseenAusstellungenMorgenPage:', error);
    return (
      <DiscoveryClient
