...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'ibiza', category: 'museen-ausstellungen' });
}

export const dynamic = 'force-dynamic';

export default async function IbizaMuseenAusstellungenPage() {
  try {
    const [trending, weekend, personalized, nightlife, upcoming] = await Promise.all([
      ...
      getUpcomingEvents(30, { city: 'Ibiza', limit: 100 }),
    ]);
    ...
    console.error('Error in IbizaMuseenAusstellungenPage:', error);
    return (
      <DiscoveryClient
