  ...
  useEffect(() => {
    if (isOpen && buttonRef.current) {
      ...
      setDropdownPosition({
        ...
        left: Math.max(8, rect.right - 224 + window.scrollX), // 224 = dropdown width (w-56)
      });
    }
  }, [isOpen]);
  ...
  const renderDropdown = () => {
    ...
    return createPortal(
      <>
        ...
        <div 
          ref={dropdownRef}
          className="fixed w-56 bg-white dark:bg-gray-800 rounded-lg shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden z-[9999]"
          style={{
