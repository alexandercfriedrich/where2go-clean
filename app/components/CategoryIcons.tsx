...
export const TheaterIcon = ({ className = '', size = 48 }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4M10 3H6a2 2 0 0 0-2 2v14c0 1.1.9 2 2 2h4" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
...
export const MuseumIcon = ({ className = '', size = 48 }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M3 21h18M4 18h16M6 18V9M10 18V9M14 18V9M18 18V9M12 2L4 9h16L12 2z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
export const FilmIcon = ({ className = '', size = 48 }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M7 3v18M17 3v18M2 9h5M17 9h5M2 15h5M17 15h5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
...
export const FoodIcon = ({ className = '', size = 48 }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M18 8h1a4 4 0 0 1 0 8h-1M2 8h14v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
...
export const MarketIcon = ({ className = '', size = 48 }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4H6zM3 6h18M16 10a4 4 0 0 1-8 0" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
export const SportsIcon = ({ className = '', size = 48 }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M12 2a10 10 0 0 0 0 20M2 12h20M12 2c-2.5 3-2.5 9 0 12M12 2c2.5 3 2.5 9 0 12" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
...
export const FamilyIcon = ({ className = '', size = 48 }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M2 21v-4a4 4 0 0 1 4-4h6a4 4 0 0 1 4 4v4M13 21v-3a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v3" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
...
export const BusinessIcon = ({ className = '', size = 48 }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16M12 11h.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
