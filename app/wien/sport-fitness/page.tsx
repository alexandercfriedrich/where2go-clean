...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'wien', category: 'sport-fitness' });
}

export const dynamic = 'force-dynamic';

export default async function WienSportFitnessPage() {
  try {
    ...
    console.error('Error in WienSportFitnessPage:', error);
    return (
      <DiscoveryClient
