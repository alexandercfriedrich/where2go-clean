...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'wien', category: 'open-air-festivals', date: 'wochenende' });
}

export const dynamic = 'force-dynamic';

export default async function WienOpenAirFestivalsWochenendePage() {
  try {
    ...
    return (
      <>        <Breadcrumbs items={[{ label: 'Wien', href: '/wien' }, { label: 'Open Air & Festivals', href: '/wien/open-air-festivals' }, { label: 'Wochenende', href: '/wien/open-air-festivals/wochenende' }]} />
        ...
        />
      <SeoContent category="open-air-festivals" date="wochenende" />

      </>
    );
  } catch (error) {
    console.error('Error in WienOpenAirFestivalsWochenendePage:', error);
    return (
      <>
        <Breadcrumbs items={[{ label: 'Wien', href: '/wien' }, { label: 'Open Air & Festivals', href: '/wien/open-air-festivals' }, { label: 'Wochenende', href: '/wien/open-air-festivals/wochenende' }]} />
        <DiscoveryClient
