...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'wien', category: 'live-konzerte', date: 'wochenende' });
}

export const dynamic = 'force-dynamic';

export default async function WienLiveKonzerteWochenendePage() {
  try {
    ...
    return (
      <>        <Breadcrumbs items={[{ label: 'Wien', href: '/wien' }, { label: 'Live-Konzerte', href: '/wien/live-konzerte' }, { label: 'Wochenende', href: '/wien/live-konzerte/wochenende' }]} />
        ...
        />
      <SeoContent category="live-konzerte" date="wochenende" />

      </>
    );
  } catch (error) {
    console.error('Error in WienLiveKonzerteWochenendePage:', error);
    return (
      <>
        <Breadcrumbs items={[{ label: 'Wien', href: '/wien' }, { label: 'Live-Konzerte', href: '/wien/live-konzerte' }, { label: 'Wochenende', href: '/wien/live-konzerte/wochenende' }]} />
        <DiscoveryClient
