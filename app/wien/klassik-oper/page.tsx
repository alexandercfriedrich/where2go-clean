...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'wien', category: 'klassik-oper' });
}

export const dynamic = 'force-dynamic';

export default async function WienKlassikOperPage() {
  try {
    ...
    console.error('Error in WienKlassikOperPage:', error);
    return (
      <DiscoveryClient
