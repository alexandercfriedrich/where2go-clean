...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'wien', category: 'familie-kinder' });
}

export const dynamic = 'force-dynamic';

export default async function WienFamilieKinderPage() {
  try {
    ...
    console.error('Error in WienFamilieKinderPage:', error);
    return (
      <DiscoveryClient
