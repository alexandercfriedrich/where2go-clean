...
export default async function WienFilmKinoMorgenPage() {
  try {
    ...
    return (
      <>        <Breadcrumbs items={[{ label: 'Wien', href: '/wien' }, { label: 'Film & Kino', href: '/wien/film-kino' }, { label: 'Morgen', href: '/wien/film-kino/morgen' }]} />
