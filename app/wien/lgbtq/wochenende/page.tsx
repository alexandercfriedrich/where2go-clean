...
export default async function WienLgbtqWochenendePage() {
  try {
    ...
    return (
      <>        <Breadcrumbs items={[{ label: 'Wien', href: '/wien' }, { label: 'LGBTQ+', href: '/wien/lgbtq' }, { label: 'Wochenende', href: '/wien/lgbtq/wochenende' }]} />
