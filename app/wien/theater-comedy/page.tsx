...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'wien', category: 'theater-comedy' });
}

export const dynamic = 'force-dynamic';

export default async function WienTheaterComedyPage() {
  try {
    ...
    console.error('Error in WienTheaterComedyPage:', error);
    return (
      <DiscoveryClient
