...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'wien', category: 'theater-comedy', date: 'wochenende' });
}

export const dynamic = 'force-dynamic';

export default async function WienTheaterComedyWochenendePage() {
  try {
    ...
    return (
      <>        <Breadcrumbs items={[{ label: 'Wien', href: '/wien' }, { label: 'Theater & Comedy', href: '/wien/theater-comedy' }, { label: 'Wochenende', href: '/wien/theater-comedy/wochenende' }]} />
        ...
        />
      <SeoContent category="theater-comedy" date="wochenende" />

      </>
    );
  } catch (error) {
    console.error('Error in WienTheaterComedyWochenendePage:', error);
    return (
      <>
        <Breadcrumbs items={[{ label: 'Wien', href: '/wien' }, { label: 'Theater & Comedy', href: '/wien/theater-comedy' }, { label: 'Wochenende', href: '/wien/theater-comedy/wochenende' }]} />
        <DiscoveryClient
