...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'wien', category: 'museen-ausstellungen' });
}

export const dynamic = 'force-dynamic';

export default async function WienMuseenAusstellungenPage() {
  try {
    const [trending, weekend, personalized, nightlife, upcoming] = await Promise.all([
      ...
      getUpcomingEvents(30, { city: 'Wien', limit: 100 }),
    ]);
    ...
    console.error('Error in WienMuseenAusstellungenPage:', error);
    return (
      <DiscoveryClient
