...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'wien', category: 'bildung-workshops' });
}

export const dynamic = 'force-dynamic';

export default async function WienBildungWorkshopsPage() {
  try {
    ...
    console.error('Error in WienBildungWorkshopsPage:', error);
    return (
      <DiscoveryClient
