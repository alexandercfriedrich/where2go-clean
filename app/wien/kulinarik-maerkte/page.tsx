...
export async function generateMetadata(): Promise<Metadata> {
  return generateCityMetadata({ city: 'wien', category: 'kulinarik-maerkte' });
}

export const dynamic = 'force-dynamic';

export default async function WienKulinarikMaerktePage() {
  try {
    ...
    console.error('Error in WienKulinarikMaerktePage:', error);
    return (
      <DiscoveryClient
