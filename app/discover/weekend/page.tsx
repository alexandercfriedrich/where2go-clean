    ...
    <>
      ...
      <noscript>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <h1 className="text-3xl font-bold mb-8">Weekend Events in {city}</h1>
      ...
      <div className="sr-only" data-crawler-visible="true">
        <h2>Weekend Events for AI Crawlers and Search Engines</h2>
        <EventListSSR events={events} city={city} limit={100} />
      </div>
      
      {/* Client-Side Interactive Component */}
      <WeekendClient initialEvents={events} city={city} />
    </>
  );
}
