      ...
      fallbackContent={
        <>
          <div style={{ marginBottom: '2rem' }}>
            <h3 style={{ marginBottom: '1rem', fontSize: '1.5rem', fontWeight: '600' }}>Wir freuen uns auf Ihre Nachricht!</h3>
          ...
          <div style={{ marginBottom: '2rem' }}>
            <h3 style={{ marginBottom: '1rem', fontSize: '1.5rem', fontWeight: '600' }}>Kontaktdaten</h3>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#20B8CD" strokeWidth="2">
          ...
          <div style={{ marginBottom: '2rem' }}>
            <h3 style={{ marginBottom: '1rem', fontSize: '1.5rem', fontWeight: '600' }}>Event Partner werden</h3>
            <p style={{ marginBottom: '1rem', lineHeight: '1.6' }}>
          ...
          <div style={{ marginBottom: '2rem' }}>
            <h3 style={{ marginBottom: '1rem', fontSize: '1.5rem', fontWeight: '600' }}>Support & Feedback</h3>
            <p style={{ marginBottom: '1rem', lineHeight: '1.6' }}>
