#!/usr/bin/env python3
"""Tanzcafe Jenseits Event Scraper - https://tanzcafejenseits.com"""
import sys, os
...
class TanzcafeJenseitsScraper(BaseVenueScraper):
    VENUE_NAME = "Tanzcafe Jenseits"
    VENUE_ADDRESS = "Nelkengasse 3, 1060 Wien"
    BASE_URL = "https://tanzcafejenseits.com"
    EVENTS_URL = "https://tanzcafejenseits.com"
...
def main():
    ...
    scraper = TanzcafeJenseitsScraper(dry_run=args.dry_run, debug=args.debug)
