...
"""
B72 Event Scraper
Extracts upcoming events from https://www.b72.at/program
"""
...
class B72Scraper(BaseVenueScraper):
    """Scraper for B72 Vienna events"""
    
    VENUE_NAME = "B72"
    VENUE_ADDRESS = "Hernalser Gürtel, Stadtbahnbogen 72, 1080 Wien"
    BASE_URL = "https://www.b72.at"
    EVENTS_URL = "https://www.b72.at/program"
    CATEGORY = "Clubs/Discos"
    SUBCATEGORY = "Electronic"
    
    def scrape_events(self) -> List[Dict]:
        """Scrape events from B72"""
...
def main():
    """CLI entry point"""
    parser = argparse.ArgumentParser(description='Scrape B72 events')
    parser.add_argument('--dry-run', action='store_true', help='Run without saving to database')
    parser.add_argument('--debug', action='store_true', help='Enable debug output')
    args = parser.parse_args()
    
    scraper = B72Scraper(dry_run=args.dry_run, debug=args.debug)
    result = scraper.run()
