#!/usr/bin/env python3
"""Why Not Event Scraper - https://why-not.at"""
import sys, os
...
class WhyNotScraper(BaseVenueScraper):
    VENUE_NAME = "Why Not"
    VENUE_ADDRESS = "Tiefer Graben 22, 1010 Wien"
    BASE_URL = "https://why-not.at"
    EVENTS_URL = "https://why-not.at"
    CATEGORY = "Clubs/Discos"
    SUBCATEGORY = "Gay Club"
...
def main():
    ...
    scraper = WhyNotScraper(dry_run=args.dry_run, debug=args.debug)
