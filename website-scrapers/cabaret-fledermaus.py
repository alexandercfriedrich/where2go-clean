#!/usr/bin/env python3
"""Cabaret Fledermaus Event Scraper - https://www.fledermaus.at/program"""
import sys, os
...
class CabaretFledermausScraper(BaseVenueScraper):
...
def main():
    ...
    scraper = CabaretFledermausScraper(dry_run=args.dry_run, debug=args.debug)
